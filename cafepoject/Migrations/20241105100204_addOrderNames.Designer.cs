...
namespace cafepoject.Migrations
{
    ...
    [Migration("20241105100204_addOrderNames")]
    partial class addOrderNames
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cafepoject.Models.Order", b =>
                {
                    b.HasOne("cafepoject.Models.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("cafepoject.Models.Product", "Product")
                        .WithMany("Orders")
